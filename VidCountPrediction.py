...
#Loading dataset
DataSet= pd.read_csv("Dataset.CSV",usecols=[3])
...
New_predictions = pd.DataFrame({'VideoCount' : []})
...
for i in range(90):
   ...
   # storing forecast
	New_predictions= New_predictions.append(pd.DataFrame({'VideoCount':OP},index=[i+1]))
